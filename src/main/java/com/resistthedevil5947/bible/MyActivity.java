...
//        CharSequence reference = bundle.getCharSequence("reference");
//        String referenceString  = reference.toString();
//
//        VerseAdapterJava ca = new VerseAdapterJava(createList(30));
...
//                bundle.putParcelableArrayList("referenceList", reference);
